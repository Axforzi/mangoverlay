...
class libx11_loader {
 public:
  ...
  decltype(&::XSetErrorHandler) XSetErrorHandler;
  decltype(&::XGrabKeyboard) XGrabKeyboard;
  decltype(&::XUngrabKeyboard) XUngrabKeyboard;
  decltype(&::XDefaultRootWindow) XDefaultRootWindow;
